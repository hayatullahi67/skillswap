  ...
  if (callState === 'incoming' && incomingCall) {
    return (
      <div className="p-6 max-w-2xl mx-auto">
        <Card className="border-blue-500 bg-blue-50 animate-pulse">
          <CardHeader className="text-center">
            <PhoneIncoming className="h-16 w-16 text-blue-600 mx-auto mb-4" />
            <CardTitle className="text-blue-800">Incoming Call</CardTitle>
            <CardDescription className="text-blue-600">
              {incomingCall.learnerName} wants to learn {incomingCall.skillName}
            </CardDescription>
          </CardHeader>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <span className={`text-sm ${
                      peer.isOnline ? 'text-green-600' : 'text-gray-500'
                    }`}>
